      ...
      <div className="flex flex-col gap-[6px] h-auto">
        <div className="flex flex-col gap-[6px]">
          <div className="flex items-center text-[12px] gap-[12px] text-[#b4b4b4] hover:text-[#000]">
            <a href="#"  className="w-[34px] h-[34px] flex items-center justify-center p-2 hover:bg-[#eeeeee] hover:rounded-[8px] text-[#b4b4b4] hover:text-[#000]">
              <div className="flex items-center justify-center w-[16px] h-[16px] p-2 ">
          ...
          <div className="flex items-center text-[12px] gap-[12px]">
            <a href="#" className="w-[34px] h-[34px] flex items-center justify-center p-2 bg-[#eeeeee] rounded-[8px]">
              <div className="flex items-center justify-center w-[16px] h-[16px] p-2 bg-[#eeeeee] rounded">
