...
function MainContainer() {
  return (
    <main className="flex justify-center items-center w-full h-full p-[32px_48px_32px_38px] gap-2 bg-[#eeeeee] overflow-auto">
      {/* Contenedor principal */}
      <div className=" w-[1785px] h-auto p-[16px] gap-[16px] bg-[#ffffff] border border-[#D8D8D8] rounded-[8px] flex flex-col justify-between">
        {/* Header */}
        <HeaderContainer />
